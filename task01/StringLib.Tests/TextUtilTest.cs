...
public class TextUtilTest
{
    ...
    [Theory]
    [MemberData(nameof(ReverseWordParams))]
    ...
    public static TheoryData<string, string> ReverseWordParams()
    {
        return new TheoryData<string, string>
        {
            // Тесты из задания
            ...
            { "Cant", "tnaC" },
            { "Hello, мир!", "olleH, рим!" },
            { "Хочу бесконечное лето", "учоХ еонченоксеб отел" },
